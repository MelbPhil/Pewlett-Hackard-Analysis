-- Retirement eligibility (list of 90,398 people)
SELECT first_name, last_name
FROM employees
WHERE birth_date BETWEEN '1952-01-01' AND '1955-12-31';


-- Retirment eligibility (list of all 41,380 people)
SELECT first_name, last_name
FROM employees
WHERE (birth_date BETWEEN '1952-01-01' AND '1955-12-31')
...
-- Creating current_emp table from retirment_info and dept emp tables
SELECT ri.emp_no,
	ri.first_name,
	ri.last_name,
	de.to_date
...
-- Why are some employees appearing twice on?

SELECT * FROM departments;
SELECT * FROM retires_by_dept;
